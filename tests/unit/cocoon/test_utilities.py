...
class CocoonUtilitiesTests(unittest.TestCase):
    ...
    def test_group_request_into_one_bad_model(self):
        ...
        # Run  tests
        self.assertRaises(AttributeError, group_request_into_one, "HoldingAdjustmentBadModel", holding_requests, ["tax_lots"])
    ...
    def test_group_request_into_one_empty_list(self):
        ...
        # Run  tests
        self.assertRaises(ValueError, group_request_into_one, "HoldingAdjustment", holding_requests, [])
    ...
    def test_group_request_into_one_index_greater_than_range(self):
        ...
        # Run  tests
        self.assertRaises(IndexError, group_request_into_one, "HoldingAdjustment", holding_requests, ["tax_lots"], batch_index=3)